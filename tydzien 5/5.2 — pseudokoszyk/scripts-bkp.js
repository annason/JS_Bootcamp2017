...
document.querySelector(".cart-product-subtotal span").innerHTML = `${product.price * (document.querySelector(".qty").value) } zł`;
document.querySelector(".rates li:first-child").appendChild(document.createTextNode(window.currencies["GBP"]));
document.querySelector(".rates li:nth-child(2)").appendChild(document.createTextNode(window.currencies["USD"]));
document.querySelector(".rates li:nth-child(3)").appendChild(document.createTextNode(window.currencies["EUR"]));
